<template>
  ...
  <div class="grid gap-3 grid-cols-12">
    ...
    <div class="mt-3 col-span-9">
      ...
      <input
        ...
        class="mt-1 focus:ring-indigo-500 focus:border-indogo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
      />
    </div>
    <!--/ Question -->
  ...
  <div>
    <div v-if="shouldHaveOptions()" class="mt-2">
      ...
      >
        <span class="w-g text-sm">{{ index + 1 }}</span>
        <input
          type="text"
          v-model="option.text"
          @change="dataChange"
...
function dataChange() {
  // wrap the data, if change the question type to text, it doesn't losse the values in options
