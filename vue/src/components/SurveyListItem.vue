    ...
    <div class="flex justify-between items-center mt-3">
      ...
      <div class="flex items-center">
        ...
        <button
          ...
          class="h-8 w-8 items-center justify-center rounded-full border border-transparent text-sm text-red-500 focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-6 w-6"
